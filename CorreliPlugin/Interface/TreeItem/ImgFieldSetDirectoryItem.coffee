...
#
class ImgFieldSetDirectoryItem extends TreeItem
...
#             _current_img : ""
    ...
    # surdefinition de add_child
    add_child: ( child ) ->
        if child instanceof FileItem
            new_file_item = new CorreliFileItem child._file
    ...
    accept_child: ( ch ) ->
        ch instanceof CorreliFileItem or
