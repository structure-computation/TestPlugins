...
#include "Soca/Database/Database.h"
...
QT_MOC_LITERAL(4, 28, 9)
    ...
    "Database\0_model_sig\0\0Model*\0end_round\0"
};
...
void Database::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Database::*_t)(Model * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Database::_model_sig)) {
                *result = 0;
            }
        }
    }
